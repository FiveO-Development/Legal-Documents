...
This Terms of Service Agreement (the **"Agreement"**) is entered into between **FiveO Development | OfficerMills** ("Bot Owner") and the user ("User") of the following Discord bots (collectively, the **"Bots"**):

- **Reviewly Feedback**  
- **Post A Note**  
- **FiveO Jail Bot**  
- **NixQueue**  
- Any additional public bots released by the Bot Owner in the future  

By using any of the Bots, the User agrees to be bound by the terms of this Agreement. If the User does not agree to the terms of this Agreement, they should immediately discontinue use of the Bots.
...
## 2. Prohibited Use
The User may not use the Bot in any way that violates applicable laws, rules, or regulations or infringes upon the rights of any third party.  
...
The place of arbitration shall be **Warren County, Tennessee, United States**.
